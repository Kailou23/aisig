...
symbols = [ 'BTC/USDT', 'ETH/USDT', 'BNB/USDT', 'SOL/USDT', 'XRP/USDT', 'ADA/USDT', 'DOGE/USDT', 'AVAX/USDT', 'DOT/USDT', 'MATIC/USDT', 'LTC/USDT', 'BCH/USDT', 'UNI/USDT', 'LINK/USDT', 'ATOM/USDT', 'FIL/USDT', 'ETC/USDT', 'NEAR/USDT', 'OP/USDT', 'APE/USDT', 'SAND/USDT', 'MANA/USDT', 'AAVE/USDT', 'AR/USDT', 'XTZ/USDT', 'RNDR/USDT', 'GALA/USDT', 'DYDX/USDT', 'PEPE/USDT', 'SHIB/USDT', 'BLUR/USDT', 'WOO/USDT', 'XLM/USDT', 'TRX/USDT', 'IMX/USDT', 'RUNE/USDT', 'COTI/USDT', 'LDO/USDT', 'FET/USDT', 'INJ/USDT' ]
